    ...
    <section className="relative overflow-hidden bg-dark-bg py-24 text-white">
      ...
      <div className="container relative mx-auto px-6">
        <div className="mx-auto max-w-3xl">
          {/* Glass CTA Card */}
          <div
            className="rounded-2xl border border-white/10 bg-white/10 p-12 shadow-2xl shadow-black/50 hover:bg-white/15 hover:border-white/20 transition-all duration-300 text-center relative overflow-hidden"
