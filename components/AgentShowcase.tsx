      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {AGENTS.map((agent, index) => (
            <div
              key={agent.id}
              className="group relative overflow-hidden rounded-xl border border-white/10 bg-white/10 p-8 shadow-2xl shadow-black/50 transition-all duration-300 hover:bg-white/15 hover:border-white/20"
              style={{
        ...
        <div
          className="mt-16 rounded-xl border border-white/10 bg-white/10 p-8 text-center shadow-2xl shadow-black/50 hover:bg-white/15 hover:border-white/20 transition-all duration-300"
